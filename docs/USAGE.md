...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of cron.create, queue.publish, queue.consume, queue.ack) and reuse it from your own code.
